...
- **Comments**: Use JSDoc (`/** ... */`) for all exported functions, methods, classes, and types. Inline comments (`//`) for non-obvious internal logic only. Keep comments concise — explain _why_, not _what_.
